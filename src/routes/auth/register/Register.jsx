...
const Register = () => {
  ...
  const validateForm = () => {
    return (
      ...
      !Object.values(usernameErrors).some((error) => error) &&
      username.trim() !== '' &&
      email.trim() !== '' &&
      phone.trim() !== '' &&
      street.trim() !== '' &&
  ...
  const handleRegisterUser = async (e) => {
    ...
    if (!validateForm()) {
      toast.error('Please fill in all fields and correct errors.');
      return;
    }
  ...
  return (
    <div className='register'>
      ...
      <form className='form-register' onSubmit={handleRegisterUser}>
        ...
        <label className='form-register__label'>{t('username')}</label>
        <input
          type='text'
          ...
          required
        />
        <ul className='form-register__errors'>
          {usernameErrors.capitalLetter && <li>{t('errorUsername')}</li>}
          {usernameErrors.length && <li>{t('errorUsername2')}</li>}
        </ul>

        <label className='form-register__label'>{t('password')}</label>
        <input
          type='password'
        ...
        <label className='form-register__label'>{t('email')}</label>
        <input
          type='email'
          placeholder={t('email')}
          value={email}
        ...
        <label className='form-register__label'>{t('phone')}</label>
        <input
          type='text'
          placeholder={t('phone')}
          value={phone}
        ...
        <label className='form-register__label'>{t('street')}</label>
        <input
          type='text'
        ...
        <label className='form-register__label'>{t('city')}</label>
        <input
          type='text'
          placeholder={t('city')}
          value={city}
        ...
        <label className='form-register__label'>{t('country')}</label>
        <input
          type='text'
